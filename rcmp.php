...
<div class="jumbotron main-jumbo">
  <div class="container">
    <h1 class="text-center">RCMP | MetaOptima</h1>
    <h3 class="text-center">BCIP project with MetaOptima & RCMP</h3>
  </div>  <!-- container-->
</div> <!-- jumbotron -->
...
<!-- -=-=-=-=- WORK INFORMATION -=-=-=-=- -->
  <div class="col-md-4">
    ...
    <a class="btn-works btn-link-out text-center" style="margin-bottom: 30px;" href="https://molescope.com/rcmp/" target="new">Visit Website</a>
  </div> <!-- column -->
<!-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- -->
</div>  <!-- container-->
