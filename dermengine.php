<?php
$pageName = "dermengine light-theme";
include ("header.php");
...
<div class="jumbotron main-jumbo">
  <div class="container">
    <h1 class="text-center">DermEngine Homepage</h1>
    <h3 class="text-center">The World's Most Advanced Skin Analytics System</h3>
  </div>  <!-- container-->
</div> <!-- jumbotron -->
...
<!-- -=-=-=-=- WORK INFORMATION -=-=-=-=- -->
  <div class="col-md-4">
    ...
    <a class="btn-works btn-link-out text-center" style="margin-bottom: 30px;" href="https://dermengine.com/" target="new">Visit Website</a>
  </div> <!-- column -->
<!-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- -->
</div>  <!-- container-->
...
<div class="container text-center">
  ...
  <div class="col-xs-6 text-center">
    <a class="btn-works btn-fill-right" href="rcmp.php">Next <span class="fa fa-long-arrow-right"></span></a>
