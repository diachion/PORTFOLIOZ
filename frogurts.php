...
<!-- -=-=-=-=- WORK INFORMATION -=-=-=-=- -->
  <div class="col-md-4">
    <h3 class="no-header"><span class="fa fa-tag icon-left"></span>Branding</h3>
    <h3 class="no-header"><span class="fa fa-calendar-check-o icon-left"></span>February 2, 2015</h3>
